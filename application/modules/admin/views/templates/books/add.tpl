...
<div class="col-sm-6 offset-sm-3">
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" id="title" value="{ci_form_validation field='title'}" placeholder="Enter Book Title">
            {ci_form_validation field='title' error='true'}
        </div>
        <div class="form-group">
            <label for="author">{ci_language line="Author"}</label>
            <input type="text" class="form-control" name="author" id="author" value="{ci_form_validation field='author'}" placeholder="Enter Author Name">
            {ci_form_validation field='author' error='true'}
        </div>
        <div class="form-group">
            <label for="published_year">{ci_language line="Published Year"}</label>
            <input type="text" class="form-control" name="published_year" id="published_year" value="{ci_form_validation field='published_year'}" placeholder="Enter Published Year">
        ...
        <div class="form-group">
            ...
            <select name="rack_id" class="form-control">
                ...
                {section name=index loop=$racks}
                    <option value="{$racks[index].id}">{$racks[index].name}</option>
                {sectionelse}
