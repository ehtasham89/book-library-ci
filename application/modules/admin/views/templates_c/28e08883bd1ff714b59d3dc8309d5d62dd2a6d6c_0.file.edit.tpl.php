...
function content_5a80d9689774c4_78986237 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="col-sm-6 offset-sm-3">
    ...
    <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" value="<?php echo $_smarty_tpl->tpl_vars['rack']->value['name'];?>
